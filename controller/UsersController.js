...
const getUserByID = (req, res) => {
    ...
    let query = `select * from users where id_number = '${req.body['id_number']}'`;
...
const updateUserWithID = (req, res) => {
    ...
    let query = ''
    if (req.body['image'])
        query = `update users set username = '${req.body['username']}', mobile_number = '${req.body['contactNumber']}', password = '${req.body['newPassword']}', profile_image_path = '${path.basename(req.body['image'])}' where id_number = '${req.body['userIDNumber']}'`
    else
        query = `update users set username = '${req.body['username']}', mobile_number = '${req.body['contactNumber']}', password = '${req.body['newPassword']}' where id_number = '${req.body['userIDNumber']}'`
